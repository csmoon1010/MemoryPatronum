...
public class GameLevel_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_level_4);
        ...
        countDownTimer = new CountDownTimer(45000, 1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GameLevel_4.this);
                alertDialogBuilder
                        .setMessage("시간 종료")
                        .setCancelable(false)
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(GameLevel_4.this, "time start", Toast.LENGTH_SHORT).show();
