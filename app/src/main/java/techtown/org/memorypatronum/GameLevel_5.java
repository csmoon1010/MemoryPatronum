...
public class GameLevel_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_level_5);
        ...
        countDownTimer = new CountDownTimer(45000, 1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GameLevel_5.this);
                alertDialogBuilder
                        .setMessage("시간 종료")
                        .setCancelable(false)
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(GameLevel_5.this, "time start", Toast.LENGTH_SHORT).show();
    ...
    private void frontOfCardsResources() {
        ...
        image109 = R.drawable.cat;
        image110 = R.drawable.dolphin;
        image111 = R.drawable.flamingo;
        image112 = R.drawable.squirrel;
        ...
        image209 = R.drawable.cat2;
        image210 = R.drawable.dolphin2;
        image211 = R.drawable.flamingo2;
        image212 = R.drawable.squirrel2;
